...
> **Note:** Example identifiers in this plan are synthetic placeholders, not drawn from any real project. The example-corpus path is resolved via the `M1_CORPUS_PATH` env var (falling back to the sibling EV-M1 example project).
